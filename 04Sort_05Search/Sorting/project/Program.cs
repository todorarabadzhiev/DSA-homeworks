namespace SortingHomework
{
    ...
    internal class Program
    {
        ...
        {
            var collection = new SortableCollection<int>(new[] { 22, 11, 101, 33, 0, 101, 25, 1, 18, 1234, -10 });
            ...
            collection = new SortableCollection<int>(new[] { 22, 11, 101, 33, 0, 101, 25, 1, 18, 1234, -10 });
